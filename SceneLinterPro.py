...
#
#   Author: Iman Shirani
#   Version: 0.0.2 - Added rule management features.
#
...
class AboutDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        title_label = QtWidgets.QLabel("SceneLinter Pro 0.0.2"); title_label.setStyleSheet("font-size: 16px; font-weight: bold;")
